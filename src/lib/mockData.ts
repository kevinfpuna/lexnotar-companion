...
export const tiposTrabajoMock: TipoTrabajo[] = [
  {
    ...
    pasosPredefinidos: [
      { numero: 1, nombre: 'Consulta inicial', estadoInicial: 'Pendiente', diasEstimados: 1, costoEstimado: 0, descripcion: 'Reunión con cliente', opcional: false },
      { numero: 2, nombre: 'Redacción del poder', estadoInicial: 'Pendiente', diasEstimados: 1, costoEstimado: 300000, descripcion: 'Elaboración del documento', opcional: false },
      { numero: 3, nombre: 'Revisión y firma', estadoInicial: 'Pendiente', diasEstimados: 1, costoEstimado: 150000, descripcion: 'Firma del poderdante', opcional: false },
      { numero: 4, nombre: 'Entrega de testimonios', estadoInicial: 'Pendiente', diasEstimados: 0, costoEstimado: 50000, descripcion: 'Entrega al cliente', opcional: false },
    ],
    fechaCreacion: new Date('2024-01-01'),
    fechaActualizacion: new Date('2024-01-01'),
    activo: true,
  },
  {
    ...
    pasosPredefinidos: [
      { numero: 1, nombre: 'Recepción de documentos', estadoInicial: 'Pendiente', diasEstimados: 2, costoEstimado: 0, descripcion: 'Verificar documentación completa', opcional: false },
      { numero: 2, nombre: 'Estudio de títulos', estadoInicial: 'Pendiente', diasEstimados: 5, costoEstimado: 500000, descripcion: 'Verificar cadena dominial', opcional: false },
      { numero: 3, nombre: 'Condición de dominio', estadoInicial: 'Pendiente', diasEstimados: 10, costoEstimado: 800000, descripcion: 'Solicitar informe en Registro', opcional: false },
      { numero: 4, nombre: 'Redacción de escritura', estadoInicial: 'Pendiente', diasEstimados: 3, costoEstimado: 1000000, descripcion: 'Elaborar documento', opcional: false },
      { numero: 5, nombre: 'Firma de partes', estadoInicial: 'Pendiente', diasEstimados: 2, costoEstimado: 500000, descripcion: 'Comparecencia y firma', opcional: false },
      { numero: 6, nombre: 'Inscripción en Registro', estadoInicial: 'Pendiente', diasEstimados: 15, costoEstimado: 500000, descripcion: 'Presentar al Registro Público', opcional: false },
      { numero: 7, nombre: 'Retiro y entrega', estadoInicial: 'Pendiente', diasEstimados: 3, costoEstimado: 200000, descripcion: 'Entregar título inscripto', opcional: false },
    ],
    fechaCreacion: new Date('2024-01-01'),
    fechaActualizacion: new Date('2024-01-01'),
    activo: true,
  },
  {
    ...
    pasosPredefinidos: [
      { numero: 1, nombre: 'Consulta y recopilación', estadoInicial: 'Pendiente', diasEstimados: 7, costoEstimado: 500000, descripcion: 'Reunir documentación', opcional: false },
      { numero: 2, nombre: 'Presentación demanda', estadoInicial: 'Pendiente', diasEstimados: 3, costoEstimado: 1000000, descripcion: 'Presentar al juzgado', opcional: false },
      { numero: 3, nombre: 'Publicación edictos', estadoInicial: 'Pendiente', diasEstimados: 30, costoEstimado: 500000, descripcion: 'Publicar en diario', opcional: false },
      { numero: 4, nombre: 'Declaratoria de herederos', estadoInicial: 'Pendiente', diasEstimados: 60, costoEstimado: 2000000, descripcion: 'Esperar resolución', opcional: false },
      { numero: 5, nombre: 'Inventario y avalúo', estadoInicial: 'Pendiente', diasEstimados: 30, costoEstimado: 1500000, descripcion: 'Listar y valorar bienes', opcional: false },
      { numero: 6, nombre: 'Partición', estadoInicial: 'Pendiente', diasEstimados: 30, costoEstimado: 1500000, descripcion: 'Dividir bienes', opcional: false },
      { numero: 7, nombre: 'Inscripciones registrales', estadoInicial: 'Pendiente', diasEstimados: 30, costoEstimado: 1000000, descripcion: 'Registrar a nombre herederos', opcional: false },
    ],
    fechaCreacion: new Date('2024-01-01'),
    fechaActualizacion: new Date('2024-01-01'),
    activo: true,
  },
  {
    ...
    pasosPredefinidos: [
      { numero: 1, nombre: 'Consulta y planificación', estadoInicial: 'Pendiente', diasEstimados: 2, costoEstimado: 300000, descripcion: 'Definir estructura', opcional: false },
      { numero: 2, nombre: 'Redacción estatutos', estadoInicial: 'Pendiente', diasEstimados: 5, costoEstimado: 1500000, descripcion: 'Elaborar contrato social', opcional: false },
      { numero: 3, nombre: 'Firma escritura', estadoInicial: 'Pendiente', diasEstimados: 2, costoEstimado: 1000000, descripcion: 'Otorgamiento notarial', opcional: false },
      { numero: 4, nombre: 'Inscripción Registro Público', estadoInicial: 'Pendiente', diasEstimados: 15, costoEstimado: 1000000, descripcion: 'Inscribir en comercio', opcional: false },
      { numero: 5, nombre: 'Obtención RUC', estadoInicial: 'Pendiente', diasEstimados: 5, costoEstimado: 500000, descripcion: 'Tramitar ante SET', opcional: false },
      { numero: 6, nombre: 'Habilitación municipal', estadoInicial: 'Pendiente', diasEstimados: 10, costoEstimado: 700000, descripcion: 'Patente comercial', opcional: true },
    ],
    fechaCreacion: new Date('2024-01-01'),
    fechaActualizacion: new Date('2024-01-01'),
    activo: true,
